...
<body onload="checkEdits()" style="/*background-color:rgb(255,255,255);*/color:rgb(77,77,77);height:1320px;">
    ...
    <section id="Areas" style="padding-top:-3px;">
        ...
        <div id="edit" contenteditable="true" style="background-color:#64abde;">
            <div class="row">
                <div class="col-xl-5">
