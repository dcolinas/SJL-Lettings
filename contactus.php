...
<body style="background-color:rgb(241,247,252);">
    ...
    <div class="contact-clean">
        <form method="POST" action="https://formspree.io/dcolinas@gmail.com">
            ...
            <div class="form-group"><input class="form-control" type="email" name="email" placeholder="Your email"><small class="form-text text-danger">Please enter a email address.</small></div>
